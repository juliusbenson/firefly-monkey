function tuningstats = ComputeTuning2D_Incontinuous(x1,x2,ts,tspk,timewindow,tuning_prs,tuning_method)

%% concatenate data from different trials
xt1 = ConcatenateTrials_Incontinuous(x1,[],tspk,ts,timewindow);
[xt2,~,yt] = ConcatenateTrials_Incontinuous(x2,[],tspk,ts,timewindow);
xt = [xt1 xt2];
