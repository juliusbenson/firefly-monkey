...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Viktor\U-probe\Feb 03 2021\';
...
monkeyInfo (end).FFparams_ypos = 8;
monkeyInfo (end).FFparams_flyDuration = 4;
monkeyInfo (end).isRipple = 0; 
monkeyInfo (end).MT_border = nan; 
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Viktor\U-probe\Feb 04 2021\';
monkeyInfo (end).comments = {'two densities, no landmarks, replay, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe32'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Viktor\U-probe\Feb 05 2021\';
monkeyInfo (end).comments = {'two densities, no landmarks,replay, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe32'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Viktor\U-probe\Feb 11 2021\';
monkeyInfo (end).comments = {'two densities, no landmarks, replay, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe32'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Viktor\U-probe\Feb 12 2021\';
monkeyInfo (end).comments = {'two densities, no landmarks, replay, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe32'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Viktor\U-probe\Feb 16 2021\';
monkeyInfo (end).comments = {'two densities, no landmarks, replay, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe32'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Viktor\U-probe\Mar 05 2021\';
monkeyInfo (end).comments = {'two densities, no landmarks, replay, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe32'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end+1).monk_id = 72;
monkeyInfo (end).session_id = 1;
monkeyInfo (end).coord.row = nan;
monkeyInfo (end).coord.column = nan;
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Marco\U-probe\Feb 10 2021\';
monkeyInfo (end).comments = {'fixed densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe32'};
monkeyInfo (end).area = {'PFC'};
monkeyInfo (end).eyechannels = [2 2];
monkeyInfo (end).FFparams_xpos = 7;
monkeyInfo (end).FFparams_ypos = 8;
monkeyInfo (end).FFparams_flyDuration = 4;
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Marco\U-probe\Feb 11 2021\';
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe32'};
monkeyInfo (end).area = {'PFC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Marco\U-probe\Feb 16 2021\';
monkeyInfo (end).comments = {'fixed densities, no landmarks, no ptb, random DCI, random ITI, gain manipulation'};
monkeyInfo (end).electrode_type = {'linearprobe32'};
monkeyInfo (end).area = {'PFC'};
monkeyInfo (end).eyechannels = [2 2];
monkeyInfo (end).FFparams_xpos = 7;
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Marco\U-probe\Feb 17 2021\';
monkeyInfo (end).comments = {'fixed densities, no landmarks, no ptb, random DCI, random ITI, gain manipulation'};
monkeyInfo (end).electrode_type = {'linearprobe32'};
monkeyInfo (end).area = {'PFC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Marco\U-probe\Feb 19 2021\';
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe32'};
monkeyInfo (end).area = {'PFC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Marco\U-probe\Feb 22 2021\';
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe32'};
monkeyInfo (end).area = {'PFC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Marco\U-probe\Feb 23 2021\';
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe32'};
monkeyInfo (end).area = {'PFC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Marco\U-probe\Feb 24 2021\';
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI, gain manipulation'};
monkeyInfo (end).electrode_type = {'linearprobe32'};
monkeyInfo (end).area = {'PFC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Marco\U-probe\Feb 25 2021\';
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI, gain manipulation'};
monkeyInfo (end).electrode_type = {'linearprobe32'};
monkeyInfo (end).area = {'PFC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Marco\U-probe\Feb 26 2021\';
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe32'};
monkeyInfo (end).area = {'PFC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Marco\U-probe\Mar 01 2021\';
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI, gain manipulation'};
monkeyInfo (end).electrode_type = {'linearprobe32'};
monkeyInfo (end).area = {'PFC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Marco\U-probe\Mar 02 2021\';
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI, gain manipulation'};
monkeyInfo (end).electrode_type = {'linearprobe32'};
monkeyInfo (end).area = {'PFC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Marco\U-probe\Mar 03 2021\';
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI, gain manipulation'};
monkeyInfo (end).electrode_type = {'linearprobe32'};
monkeyInfo (end).area = {'PFC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Marco\U-probe\Mar 04 2021\';
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI, gain manipulation'};
monkeyInfo (end).electrode_type = {'linearprobe32'};
monkeyInfo (end).area = {'PFC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end+1).monk_id = 73;
monkeyInfo (end).session_id = 1;
monkeyInfo (end).coord.row = nan;
monkeyInfo (end).coord.column = nan;
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Jimmy\U-probe\Mar 10 2021\';
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe32'};
monkeyInfo (end).area = {'7a'};
monkeyInfo (end).eyechannels = [2 2];
monkeyInfo (end).FFparams_xpos = 7;
monkeyInfo (end).FFparams_ypos = 8;
monkeyInfo (end).FFparams_flyDuration = 4;
monkeyInfo (end).isRipple = 0; 
monkeyInfo (end).MT_border = nan; 
monkeyInfo (end).basicFF = 1; 
monkeyInfo (end).twoFF = 0; 
monkeyInfo (end).visual_acc_control = 0; 
monkeyInfo (end).multisensory_acc_control = 0; 
monkeyInfo (end).movingFF = 0; 
monkeyInfo (end).unityVR = 0;
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Jimmy\U-probe\Mar 12 2021\';
monkeyInfo (end).comments = {'acceleration control, two densities, one tau of tau, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe32'};
monkeyInfo (end).area = {'7a'};
monkeyInfo (end).eyechannels = [2 2];
monkeyInfo (end).FFparams_xpos = 7;
...
monkeyInfo (end).isRipple = 0; 
monkeyInfo (end).MT_border = nan; 
monkeyInfo (end).basicFF = 0; 
monkeyInfo (end).twoFF = 0; 
monkeyInfo (end).visual_acc_control = 1; 
monkeyInfo (end).multisensory_acc_control = 0; 
monkeyInfo (end).movingFF = 0; 
monkeyInfo (end).unityVR = 0;
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Jimmy\U-probe\Mar 15 2021\';
monkeyInfo (end).comments = {'acceleration control, two densities, one tau of tau, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe32'};
monkeyInfo (end).area = {'7a'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Jimmy\U-probe\May 05 2021\';
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe32'};
monkeyInfo (end).area = {'8ar'};
monkeyInfo (end).eyechannels = [2 2];
monkeyInfo (end).FFparams_xpos = 7;
monkeyInfo (end).FFparams_ypos = 8;
monkeyInfo (end).FFparams_flyDuration = 4;
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Jimmy\U-probe\May 13 2021\';
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe32'};
monkeyInfo (end).area = {'8ar'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Jimmy\U-probe\May 17 2021\';
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe32'};
monkeyInfo (end).area = {'8ar'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Jimmy\U-probe\May 20 2021\';
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe32'};
monkeyInfo (end).area = {'8ar'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Jimmy\U-probe\May 27 2021\';
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe32'};
monkeyInfo (end).area = {'8ar'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Jimmy\U-probe\Jul 14 2021\';
monkeyInfo (end).comments = {'one density, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe32'};
monkeyInfo (end).area = {'7a'};
monkeyInfo (end).eyechannels = [2 2];
monkeyInfo (end).FFparams_xpos = 7;
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Jimmy\U-probe\Jul 28 2021\';
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe32'};
monkeyInfo (end).area = {'7a'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Jimmy\U-probe\Jul 29 2021\';
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe32'};
monkeyInfo (end).area = {'7a'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Jimmy\U-probe\Jul 30 2021\';
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe32'};
monkeyInfo (end).area = {'7a'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Jimmy\U-probe\Aug 02 2021\';
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe32'};
monkeyInfo (end).area = {'7a'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Jimmy\U-probe\Aug 04 2021\';
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe32'};
monkeyInfo (end).area = {'8ar'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Jimmy\U-probe\Aug 05 2021\';
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe32'};
monkeyInfo (end).area = {'8ar'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Jimmy\U-probe\Aug 18 2021\';
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe32'};
monkeyInfo (end).area = {'8ar'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Jimmy\U-probe\Aug 19 2021\';
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe32'};
monkeyInfo (end).area = {'8ar'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Jimmy\U-probe\Aug 30 2021\';
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe32'};
monkeyInfo (end).area = {'8ar'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Jimmy\U-probe\Sep 02 2021\';
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe32'};
monkeyInfo (end).area = {'8ar'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Jimmy\U-probe\Sep 15 2021\';
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe32'};
monkeyInfo (end).area = {'8ar'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Jimmy\U-probe\Sep 16 2021\';
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe32'};
monkeyInfo (end).area = {'8ar'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Jimmy\U-probe\Sep 28 2021\';
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe32'};
monkeyInfo (end).area = {'8ar'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Jimmy\U-probe\Sep 30 2021\';
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe32'};
monkeyInfo (end).area = {'8ar'};
monkeyInfo (end).eyechannels = [0 0];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Jimmy\U-probe\Apr 18 2022\';
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe32'};
monkeyInfo (end).area = {'8ar'};
monkeyInfo (end).eyechannels = [0 0];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Jimmy\U-probe\Apr 20 2022\';
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe32'};
monkeyInfo (end).area = {'8ar'};
monkeyInfo (end).eyechannels = [0 0];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Jimmy\U-probe\Apr 21 2022\';
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe32'};
monkeyInfo (end).area = {'8ar'};
monkeyInfo (end).eyechannels = [0 0];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Jimmy\U-probe\Apr 25 2022\';
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe32'};
monkeyInfo (end).area = {'8ad'};
monkeyInfo (end).eyechannels = [0 0];
monkeyInfo (end).FFparams_xpos = 7;
monkeyInfo (end).FFparams_ypos = 8;
monkeyInfo (end).FFparams_flyDuration = 4;
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Jimmy\U-probe\Apr 27 2022\';
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe32'};
monkeyInfo (end).area = {'8ar'};
monkeyInfo (end).eyechannels = [0 0];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Jimmy\U-probe\Apr 28 2022\';
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe32'};
monkeyInfo (end).area = {'8ad'};
monkeyInfo (end).eyechannels = [0 0];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Jimmy\U-probe\May 03 2022\';
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe32'};
monkeyInfo (end).area = {'8ar'};
monkeyInfo (end).eyechannels = [0 0];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Jimmy\U-probe\May 04 2022\';
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe32'};
monkeyInfo (end).area = {'8ad'};
monkeyInfo (end).eyechannels = [0 0];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Jimmy\U-probe\May 05 2022\';
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe32'};
monkeyInfo (end).area = {'8ad'};
monkeyInfo (end).eyechannels = [0 0];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Jimmy\U-probe\May 09 2022\';
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe32'};
monkeyInfo (end).area = {'8ad'};
monkeyInfo (end).eyechannels = [0 0];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Jimmy\U-probe\May 10 2022\';
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe32'};
monkeyInfo (end).area = {'8av'};
monkeyInfo (end).eyechannels = [0 0];
monkeyInfo (end).FFparams_xpos = 7;
monkeyInfo (end).FFparams_ypos = 8;
monkeyInfo (end).FFparams_flyDuration = 4;
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Jimmy\U-probe\May 12 2022\';
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe32'};
monkeyInfo (end).area = {'8ad'};
monkeyInfo (end).eyechannels = [0 0];
...
monkeyInfo (end+1).monk_id = 71;
monkeyInfo (end).session_id = 1003;
monkeyInfo (end).coord.row = nan;
monkeyInfo (end).coord.column = nan;
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Viktor\Utah Array\Nov 18 2021\';
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'utah128', 'utah128'};
...
monkeyInfo (end+1).monk_id = 71;
monkeyInfo (end).session_id = 1004;
monkeyInfo (end).coord.row = nan;
monkeyInfo (end).coord.column = nan;
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Viktor\Utah Array\Nov 19 2021\';
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'utah128', 'utah128'};
monkeyInfo (end).area = {'PFC', 'PPC'};
monkeyInfo (end).eyechannels = [0 0];
...
monkeyInfo (end+1).monk_id = 71;
monkeyInfo (end).session_id = 1005;
monkeyInfo (end).coord.row = nan;
monkeyInfo (end).coord.column = nan;
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Viktor\Utah Array\Nov 22 2021\';
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'utah128', 'utah128'};
monkeyInfo (end).area = {'PFC', 'PPC'};
monkeyInfo (end).eyechannels = [0 0];
...
monkeyInfo (end+1).monk_id = 71;
monkeyInfo (end).session_id = 1006;
monkeyInfo (end).coord.row = nan;
monkeyInfo (end).coord.column = nan;
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Viktor\Utah Array\Nov 24 2021\';
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'utah128', 'utah128'};
monkeyInfo (end).area = {'PFC', 'PPC'};
monkeyInfo (end).eyechannels = [0 0];
...
monkeyInfo (end+1).monk_id = 71;
monkeyInfo (end).session_id = 1007;
monkeyInfo (end).coord.row = nan;
monkeyInfo (end).coord.column = nan;
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Viktor\Utah Array\Nov 30 2021\';
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'utah128', 'utah128'};
monkeyInfo (end).area = {'PFC', 'PPC'};
monkeyInfo (end).eyechannels = [0 0];
...
monkeyInfo (end+1).monk_id = 71;
monkeyInfo (end).session_id = 1008;
monkeyInfo (end).coord.row = nan;
monkeyInfo (end).coord.column = nan;
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Viktor\Utah Array\Dec 01 2021\';
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'utah128', 'utah128'};
monkeyInfo (end).area = {'PFC', 'PPC'};
monkeyInfo (end).eyechannels = [0 0];
...
monkeyInfo (end+1).monk_id = 71;
monkeyInfo (end).session_id = 1009;
monkeyInfo (end).coord.row = nan;
monkeyInfo (end).coord.column = nan;
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Viktor\Utah Array\Dec 02 2021\';
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'utah128', 'utah128'};
monkeyInfo (end).area = {'PFC', 'PPC'};
monkeyInfo (end).eyechannels = [0 0];
...
monkeyInfo (end+1).monk_id = 71;
monkeyInfo (end).session_id = 1011;
monkeyInfo (end).coord.row = nan;
monkeyInfo (end).coord.column = nan;
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Viktor\Utah Array\Dec 06 2021\';
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'utah128', 'utah128'};
monkeyInfo (end).area = {'PFC', 'PPC'};
monkeyInfo (end).eyechannels = [0 0];
...
monkeyInfo (end+1).monk_id = 71;
monkeyInfo (end).session_id = 1012;
monkeyInfo (end).coord.row = nan;
monkeyInfo (end).coord.column = nan;
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Viktor\Utah Array\Dec 08 2021\';
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'utah128', 'utah128'};
monkeyInfo (end).area = {'PFC', 'PPC'};
monkeyInfo (end).eyechannels = [0 0];
...
monkeyInfo (end+1).monk_id = 71;
monkeyInfo (end).session_id = 1013;
monkeyInfo (end).coord.row = nan;
monkeyInfo (end).coord.column = nan;
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Viktor\Utah Array\Dec 09 2021\';
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'utah128', 'utah128'};
monkeyInfo (end).area = {'PFC', 'PPC'};
monkeyInfo (end).eyechannels = [0 0];
...
monkeyInfo (end+1).monk_id = 71;
monkeyInfo (end).session_id = 468;
monkeyInfo (end).coord.row = nan;
monkeyInfo (end).coord.column = nan;
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Viktor\Utah Array\Apr 29 2021\';
monkeyInfo (end).comments = {'two densities, replay, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'utah128', 'utah128'};
monkeyInfo (end).area = {'PFC', 'PPC'};
monkeyInfo (end).eyechannels = [0 0];
monkeyInfo (end).FFparams_xpos = 7;
...
monkeyInfo (end+1).monk_id = 71;
monkeyInfo (end).session_id = 480;
monkeyInfo (end).coord.row = nan;
monkeyInfo (end).coord.column = nan;
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Viktor\Utah Array\May 04 2021\';
monkeyInfo (end).comments = {'two densities, replay, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'utah128', 'utah128'};
monkeyInfo (end).area = {'PFC', 'PPC'};
monkeyInfo (end).eyechannels = [0 0];
...
monkeyInfo (end+1).monk_id = 71;
monkeyInfo (end).session_id = 484;
monkeyInfo (end).coord.row = nan;
monkeyInfo (end).coord.column = nan;
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Viktor\Utah Array\May 05 2021\';
monkeyInfo (end).comments = {'two densities, replay, no landmarks, ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'utah128', 'utah128'};
monkeyInfo (end).area = {'PFC', 'PPC'};
monkeyInfo (end).eyechannels = [0 0];
monkeyInfo (end).FFparams_xpos = 7;
...
monkeyInfo (end+1).monk_id = 71;
monkeyInfo (end).session_id = 466;
monkeyInfo (end).coord.row = nan;
monkeyInfo (end).coord.column = nan;
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Viktor\Utah Array\May 18 2021\';
monkeyInfo (end).comments = {'two densities, replay, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'utah128', 'utah128'};
monkeyInfo (end).area = {'PFC', 'PPC'};
monkeyInfo (end).eyechannels = [0 0];
...
monkeyInfo (end+1).monk_id = 71;
monkeyInfo (end).session_id = 488;
monkeyInfo (end).coord.row = nan;
monkeyInfo (end).coord.column = nan;
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Viktor\Utah Array\May 25 2021\';
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'utah128', 'utah128'};
monkeyInfo (end).area = {'PFC', 'PPC'};
monkeyInfo (end).eyechannels = [0 0];
...
monkeyInfo (end+1).monk_id = 71;
monkeyInfo (end).session_id = 490;
monkeyInfo (end).coord.row = nan;
monkeyInfo (end).coord.column = nan;
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Viktor\Utah Array\May 26 2021\';
monkeyInfo (end).comments = {'two densities, replay, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'utah128', 'utah128'};
monkeyInfo (end).area = {'PFC', 'PPC'};
monkeyInfo (end).eyechannels = [0 0];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Test\U-probe\Mar 15 2021\';
monkeyInfo (end).comments = {'test ripple markers'};
monkeyInfo (end).electrode_type = {'linearprobe32'};
monkeyInfo (end).area = {'blackrock simulator'};
monkeyInfo (end).eyechannels = [0 0];
monkeyInfo (end).FFparams_xpos = 7;
monkeyInfo (end).FFparams_ypos = 8;
monkeyInfo (end).FFparams_flyDuration = 4;
